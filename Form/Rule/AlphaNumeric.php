 ...
 * an element has a value that consists of only letters and numbers or nothing
 * at all.
 *
 ...
 *
 * Alphanumeric is not the same as alpha and numeric.
 *
...
class Structures_Form_Rule_AlphaNumeric extends Structures_Form_Rule_Regex {
     ...
     * @var    string
     */
    protected $errorMessage = '{elementName} may only contain numbers and letters.';
